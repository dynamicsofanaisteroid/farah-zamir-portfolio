  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        {/* Buero Bull Card */}
        <Link href="/projects/buero-bull" className="block border rounded-xl p-6 hover:shadow-sm transition-shadow">
          <h3 className="text-xl font-semibold mb-3">Buero Bull</h3>
          <p className="text-slate-600 mb-4">
                  A solo-built, in-production guidance layer that translates UK farm compliance and grants rules into plain English for English farmers. Retrieves from ingested GOV.UK guidance, fills a fixed process-page template — never freeform chat — and shows the date each source was last verified.
          </p>
          <span className="text-sm text-slate-500">Applied AI • RAG • Public-Good Tooling</span>
        </Link>
      </div>
    </div>
  )
